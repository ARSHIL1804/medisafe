module medisafe_addr::medisafe_v3{
    use std::error;
    ...
    fun add_record_test(
        ...
        add_record(account,1232323232,utf8(b"MY RECORD"),utf8(b"FILE"),utf8(b"HASH123"));
    ...
    fun give_record_access_test(
        ...
        add_record(account1,101,utf8(b"MY RECORD"),utf8(b"FILE"),utf8(b"HASH123"));
        let record_id = 0;
