...
export function SidebarDesktop(props: any) {
  ...
  return (
    <aside className="w-[270px] max-w-xs h-screen border-r-2 flex flex-col border-border">
        ...
        <div>
          <div className="flex flex-col gap-1 w-full">
            {user?.usertype == USER_TYPE.DOCTOR ? (
              ...
              <Link key={2} href={"/dashboard/my-records"}>
                <SidebarButton
                  variant={
                    pathname === "/dashboard/my-records" ? "secondary" : "ghost"
                  }
                  icon={LucideFile}
                  className="w-full"
                >
            ...
            <Link key={5} href={"/dashboard/shared"}>
              <SidebarButton
                variant={
                  pathname === "/dashboard/shared" ? "secondary" : "ghost"
                }
